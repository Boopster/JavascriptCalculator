...
// 1. Do the number buttons update the display of the running total? - yes
// 2. Do the arithmetical operations update the display with the result of the operation? - yes
// 3. Can multiple operations be chained together? - yes
